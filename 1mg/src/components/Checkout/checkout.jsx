...
import { DecreasequantityAction, IncreasequantityAction, DeleteitemAction } from "../../redux/Cart/AddtoCart_action"
...
function Checkout() {
    ...
    useEffect(() =>{
        ...
        const discPrice = itemprice.reduce((acc, element) => {
            // console.log(ele.Actual_price);
            return acc + ((Math.floor(element.Actual_price - ((element.Actual_price * element.state.discount)/ 100)))*(element.qty));
        }, 0)
    ...
    return (
        <div className="main1">
            ...
            <span className="Cart" style={{fontSize:"20px",fontWeight:"500",color:"#FF6F61",marginTop:"40px"}}>My Cart</span>
                            ...
                            return (
                                ...
                                <div className='top'>
                                    ...
                                    <div className='box_text'>
                                        ...
                                        <h5>Brand: {element.state.brand} && Category: {element.state.category} </h5>
                                        <p style={{ fontSize: 13,fontFamily:"Arial, Helvetica, sans-serif", cursor: "pointer" }} onClick={() => dlt(id)}>
                                    ...
                                    <div className="price_box">
                                        ...
                                        <div className="inc" style={{ width: 100, cursor: "pointer", background: "#FF6F61", color: "#111" }}>
                                            <span style={{ fontSize: 15 ,background: "#FF6F61",color: "#FFFFFF"}} onClick={() => remove(id)}>-</span>
                                            <span style={{ fontSize: 14 ,background: "#FF6F61",color: "#FFFFFF"}}>{element.qty}</span>
                                            <span style={{ fontSize: 15 ,background: "#FF6F61",color: "#FFFFFF"}} onClick={() => send(id)}>+</span>
                                        </div>
